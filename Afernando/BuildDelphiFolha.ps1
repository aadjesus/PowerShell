param (
	[string]$sDir = "C:\vsts-agent\_work\1\s\src",
	[string]$aDir = "C:\vsts-agent\_work\1\a",
	[string]$bDir = "C:\vsts-agent\_work\1\b",
    [string]$PFilesDir = "C:\vsts-agent\BuildTools\Delphi",
    [string]$branch = "",
    [string]$buildID = "",
...
$arrPassageiros = "Arrecadacao.dpr","AgendaImpAutomatica.dpr","BilhetagemEletronica.dpr","ImportacaoFilipeta.dpr","VerificaConexao.dpr","PRJ_PRODATA.dpr","Coeficientes.dpr","CNC.dpr","EMTU.dpr","Escala.dpr","EscalaRodoviaria.dpr","EscalaRodoviariaAutomatica.dpr","Fretamento.dpr","InfGeoPosicionamento.dpr","Passes.dpr","Plantao.dpr","AppService_SaidaRecolAuto.dpr","PVT.dpr","Retaguarda.dpr","ImpMaquina.dpr","SAF.dpr","Trafego.dpr","Turismo.dpr","VendaBilhetes.dpr","BaixaAutomaticaReservasComBoletos.dpr","ControlaProgLeitora.dpr","LeitoraDeBilhetes.dpr","RDA.dpr","CSB.dpr"
$arrPassageirosReduzido = "Arrecadacao.dpr","AgendaImpAutomatica.dpr","Escala.dpr","EscalaRodoviaria.dpr","EscalaRodoviariaAutomatica.dpr","Fretamento.dpr","Plantao.dpr","PVT.dpr","Retaguarda.dpr","ImpMaquina.dpr","SAF.dpr","Trafego.dpr","Turismo.dpr","VendaBilhetes.dpr","CSB.dpr"
...
$arrOficinas = "Abastecimento.dpr","Acidentes.dpr","Componente.dpr","Compras.dpr","DVS.dpr","Estoque.dpr","Frota.dpr","Manutencao.dpr","Motor.dpr","Pneus.dpr","Tratamento.dpr","GlobusReport.dpr"
$arrOficinasReduzido = "Abastecimento.dpr","Acidentes.dpr","Componente.dpr","Compras.dpr","DVS.dpr","Estoque.dpr","Frota.dpr","Manutencao.dpr","Motor.dpr","Pneus.dpr","Tratamento.dpr" 
